...
export default function TournamentView() {
  ...
  useEffect(() => {
    if (!clubId || !tournamentId) navigate(createPageUrl('ClubSelector'));
  ...
  const formatLabel = tournament.comp_format
    ? tournament.comp_format.charAt(0).toUpperCase() + tournament.comp_format.slice(1)
    : null;
