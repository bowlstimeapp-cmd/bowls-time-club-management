...
export default function Layout({ children, currentPageName }) {
  ...
  const noClubPages = ['ClubSelector', 'PlatformAdmin', 'ClubAnalyticsDashboard', 'PlatformInvoices', 'InvoiceView', 'CountyHome', 'CountyMembers', 'CountySelections', 'CountyAffiliations', 'CountyAdmin', 'CountyTournaments', 'CountyTournamentEditor', 'CountyTournamentView', 'CountyRegistration', 'CountyEntriesAdmin'];
