...
const SECTIONS = [
  {
    ...
    steps: [
      ...
      {
        heading: 'Adding new members',
        instructions: [
          'Go to **Admin** → **Members** (or click **Members** in the Admin dropdown).',
          'Click **Add Member** to open the new member form.',
          'Enter the member\'s **Title**, **First Name**, and **Surname**.',
          'Enter their **Email Address** — this is used for their login and notifications. If they do not have an email address, you can leave this blank and they will be added without app access.',
          'Enter their **Phone Number** (optional).',
          'Select their **Membership Groups** (for example: Winter Indoor Member, Summer Indoor Member, Outdoor Member, Social Member).',
          'Set their **Role** — Member, Steward, Selector, Secretary, Live Scorer, or Admin. Most members should be set to Member.',
          'Set their **Membership Status** to Approved (they can access the app immediately) or Pending (they must be approved before they can access the app).',
          'Click **Save** to add the member to your club.',
        ],
        tip: 'If you set a member\'s status to Pending, they will not be able to access the app until you approve them. Use Pending for members who need to pay a fee or complete a form before joining.',
      },
      {
        heading: 'Importing members in bulk',
        instructions: [
          'Go to **Admin** → **Members**.',
          'Click **Bulk Import** to open the import dialog.',
          'Download the **CSV template** if you need a starting point — this ensures your file has the correct column headers.',
          'Prepare your CSV file with the following columns: Title, First Name, Surname, Email, Phone, Membership Groups, Role, and Membership Status. Each row represents one member.',
          'Drag and drop your CSV file into the import area, or click **Browse** to select the file from your computer.',
          'Review the preview of the imported data — the system will show you how many members will be added and flag any errors (for example, missing required fields).',
          'Click **Confirm Import** to add all the members to your club.',
          'A summary will show how many members were added successfully and how many had errors.',
        ],
        tip: 'Bulk import is ideal for setting up a new club at the start of the season. You can import all your existing members in one go, then assign roles and membership groups individually afterwards.',
      },
      {
        heading: 'Changing member roles',
        instructions: [
          'Go to **Admin** → **Members**.',
          'Find the member whose role you want to change — use the search box to filter by name or email.',
          'Click on the member\'s name to open their **Member Details** dialog.',
          'In the **Role** dropdown, select the new role: Member, Steward, Selector, Secretary, Live Scorer, or Admin.',
          '**Member** — standard access; can book rinks, view selections, and enter competitions.',
          '**Steward** — can approve, reject, and manage bookings in addition to member features.',
          '**Selector** — can create and publish match selections in addition to member features.',
          '**Secretary** — has the same access as a Steward, typically used for club secretaries.',
          '**Live Scorer** — can enter live scores on match day in addition to member features.',
          '**Admin** — full access to all club admin features, including settings, member management, and all modules.',
          'Click **Save** to apply the new role.',
        ],
        tip: 'Be careful when assigning the Admin role — Admins have full access to all club settings and can manage other members. Only assign Admin to trusted club officials. You can change a member\'s role back at any time.',
      },
      {
        heading: 'Approving pending members',
        instructions: [
          'When a new member requests to join your club, their status is set to **Pending**. You will see a notification badge on the Members page showing how many pending members are waiting.',
          'Go to **Admin** → **Members**.',
          'Click on the **Pending** filter tab to see all members awaiting approval.',
          'Review each member\'s details — name, email, and any information they provided when requesting to join.',
          'To approve a member, click **Approve** next to their name. They will immediately gain access to the app and receive a welcome email.',
          'To reject a member, click **Reject** next to their name. They will be removed from the pending list and will not gain access to the app.',
          'To approve or reject multiple members at once, select them using the checkboxes and click **Bulk Approve** or **Bulk Reject**.',
        ],
        tip: 'When you approve a member, they receive an automated email with a login link. If they do not receive the email, ask them to check their junk or spam folder, or contact them directly with the app URL.',
      },
    ],
  },
  {
